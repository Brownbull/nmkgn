...
class Document(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("document_type = 'consumer_credit'", name="ck_documents_document_type"),
        CheckConstraint("upload_status in ('pending', 'stored', 'failed')", name="ck_documents_upload_status"),
        CheckConstraint(
    ...
    document_type: Mapped[str] = mapped_column(String(64), nullable=False, default="consumer_credit")
    original_filename: Mapped[str] = mapped_column(String(255), nullable=False)
    content_type: Mapped[str] = mapped_column(String(120), nullable=False)
    byte_size: Mapped[int] = mapped_column(Integer, nullable=False)
    checksum_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    storage_key: Mapped[str] = mapped_column(Text, nullable=False)
    upload_status: Mapped[str] = mapped_column(String(32), nullable=False, default="stored")
