...
| Claude design static preview | 15181 | `http://127.0.0.1:15181/` | nmkgn | Optional: `python3 -m http.server 15181 --bind 127.0.0.1 --directory docs/design/incoming/claude-design-20260513` |
